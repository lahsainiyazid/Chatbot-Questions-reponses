...
class QuestionRequest(BaseModel):
    question:str 
llm_expansion=ChatGroq(model="llama-3.1-8b-instant",temperature=0,api_key=os.environ.get("GROQ_API_KEY"),max_tokens=80)
llm_answer=ChatGroq(model="llama-3.1-8b-instant",temperature=0,api_key=os.environ.get("GROQ_API_KEY"),max_tokens=300)
documents=[]
try:
