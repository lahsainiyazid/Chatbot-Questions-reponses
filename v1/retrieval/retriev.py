...
db=Chroma(persist_directory="/home/yazid/stage/v1/embeddings+db/db_questions_1",embedding_function=embeddings,collection_name="db_questions_1")
with open("/home/yazid/stage/v1/chunking/chunks_questions_v1.json","r",encoding="utf-8") as f:
    data=json.load(f)
for item in data:
    text=f"""Content:{item.get("page_content","")}
        """.strip()
